...
#define GENERAL_CFGRBIT(REG,BIT_VAL,BIT_NUMBER,NUMBER) do { GENERAL_SETBIT(REG,BIT_VAL,BIT_NUMBER); GENERAL_CLEARBIT(REG,REVERSE_BIT(BIT_VAL,NUMBER),BIT_NUMBER);} while(0)
